...
const ProgramEdit: React.FC = () => {
  ...
  console.log(user);
  // Alternatively, you can also use useParams to get userId from URL params
  ...
  // return (
  //   <div className="mt-28">
  //     <h2>Edit {user.username}'s Program</h2>
  //     <div>
  //       <h3>{user.program.id}</h3>

  //       {/* Add editing UI for the program here */}
  //     </div>
  //   </div>
  // );
  return (
